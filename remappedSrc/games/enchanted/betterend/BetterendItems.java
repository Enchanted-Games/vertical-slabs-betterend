...
import games.enchanted.betterend.registry.types.VerticalSlabItem;
...
public class BetterendItems {
    ...
    public static BlockItem registerBlockItem(Block blockId ,String id) {
        ...
        return Registry.register(Registry.ITEM, new Identifier(VerticalSlabsBetterend.MOD_ID, id), new VerticalSlabItem(blockId, settings));
    }
