package games.enchanted.betterend.shared;

import games.enchanted.VerticalSlabsBetterend;
import games.enchanted.betterend.registry.types.CombinableVerticalSlabBlock;
...
public class registerBlocks {
    ...
    public static Block registerVerticalWoodSlab(String id) {
        ...
        return Registry.register(Registry.BLOCK, new Identifier(VerticalSlabsBetterend.MOD_ID, id), new CombinableVerticalSlabBlock(settings, SoundEvents.BLOCK_WOOD_PLACE));
    }
    ...
    public static Block registerVerticalStoneSlab(String id) {
        ...
        return Registry.register(Registry.BLOCK, new Identifier(VerticalSlabsBetterend.MOD_ID, id), new CombinableVerticalSlabBlock(settings, SoundEvents.BLOCK_STONE_PLACE));
    }
    public static Block registerVerticalNetherBrickSlab(String id) {
        ...
        return Registry.register(Registry.BLOCK, new Identifier(VerticalSlabsBetterend.MOD_ID, id), new CombinableVerticalSlabBlock(settings, SoundEvents.BLOCK_NETHER_BRICKS_PLACE));
    }
    public static Block registerVerticalDeepslateSlab(String id) {
        ...
        return Registry.register(Registry.BLOCK, new Identifier(VerticalSlabsBetterend.MOD_ID, id), new CombinableVerticalSlabBlock(settings, SoundEvents.BLOCK_DEEPSLATE_PLACE));
    }
    public static Block registerVerticalDeepslateBrickSlab(String id) {
        ...
        return Registry.register(Registry.BLOCK, new Identifier(VerticalSlabsBetterend.MOD_ID, id), new CombinableVerticalSlabBlock(settings, SoundEvents.BLOCK_DEEPSLATE_BRICKS_PLACE));
    }
    public static Block registerVerticalDeepslateTileSlab(String id) {
        ...
        return Registry.register(Registry.BLOCK, new Identifier(VerticalSlabsBetterend.MOD_ID, id), new CombinableVerticalSlabBlock(settings, SoundEvents.BLOCK_DEEPSLATE_TILES_PLACE));
    }
    ...
    public static Block registerVerticalCopperSlab(String id) {
        ...
        return Registry.register(Registry.BLOCK, new Identifier(VerticalSlabsBetterend.MOD_ID, id), new CombinableVerticalSlabBlock(settings, SoundEvents.BLOCK_COPPER_PLACE));
    }
    public static Block registerVerticalWoolSlab(String id) {
        ...
        return Registry.register(Registry.BLOCK, new Identifier(VerticalSlabsBetterend.MOD_ID, id), new CombinableVerticalSlabBlock(settings, SoundEvents.BLOCK_WOOL_PLACE));
    }
    ...
    public static Block registerVerticalAmethystSlab(String id) {
        ...
        return Registry.register(Registry.BLOCK, new Identifier(VerticalSlabsBetterend.MOD_ID, id), new CombinableVerticalSlabBlock(settings, SoundEvents.BLOCK_AMETHYST_BLOCK_PLACE));
    }
